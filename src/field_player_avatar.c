...
{
    return sPlayerAvatarGfxIds[gSaveBlock2Ptr->costumeId][state][gender];
}
...
static u8 GetPlayerAvatarStateTransitionByGraphicsId(u8 graphicsId, u8 gender)
{
    ...
    {
        if (sPlayerAvatarGfxToStateFlag[gSaveBlock2Ptr->costumeId][gender][i][0] == graphicsId)
            return sPlayerAvatarGfxToStateFlag[gSaveBlock2Ptr->costumeId][gender][i][1];
    }
